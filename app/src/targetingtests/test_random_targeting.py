"""
This module tests the RandomTargeting class
"""
import pygame
...
def test_select_target():
    """
    This function tests the select_target() method of the RandomTargeting class
    """
    screen: Surface = constants_fixture()
    targeting: RandomTargeting = RandomTargeting()
